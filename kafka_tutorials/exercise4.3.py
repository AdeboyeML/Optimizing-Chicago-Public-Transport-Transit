...
def configure_connector():
    ...
    #       tail -f /var/log/journal/confluent-kafka-connect.service.log --logs to debug/diagnosis kafka connect 
    #       kafka-console-consumer --bootstrap-server localhost:9092 --topic name of topic --from-beginning
