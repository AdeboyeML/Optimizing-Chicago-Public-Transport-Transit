...
-- Create a table of user data and purchases, as well as a stream of click events
CREATE TABLE users
(username VARCHAR,
email VARCHAR,
...
-- Create a join table of user purchases with user data
...
-- Create a stream joining user purchases to user clicks
...
-- Finally, we'll build our aggregated output.
